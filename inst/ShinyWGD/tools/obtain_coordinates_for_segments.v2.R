#' Obtain the physical coordinates for the segment
#'
#' @param seg_file segments.txt produced by i-ADHoRe
#' @param sp1 species one
#' @param gff_file1 the annotation file for species one
#' @param out_file output file to save the coordinates
#' @param sp2 species two, default NUll
#' @param gff_file2 the annotation file for species two, default NULL
#'
#' @export
#'
