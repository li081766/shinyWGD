#' Obtain coordinates for multiple species alignments
#'
#' @param seg_df segments.txt produced by i-ADHoRe
#' @param gff_df a dataframe includes the annotation file
#' @param input a object of shiny
#' @param out_file 
